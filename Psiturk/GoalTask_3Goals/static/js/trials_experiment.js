...
var contexts = [
    ...
    {'ctx': 6, 'response_handler': response_handler_a, 'goal_id': 'B', 'color': list_colors.pop()},

    // has goal C (both mappings)
    {'ctx': 7, 'response_handler': response_handler_a, 'goal_id': 'C', 'color': list_colors.pop()},
...
var context_queue = randomize_context_queue(balance.slice(), 0.24);
