...
var contexts_a = [
    ...
    {'ctx': 2, 'response_handler': response_handler_b, 'goal_id': 'B', 'color': list_colors.pop()},
    ...
    // has goal B (popular mapping)
    {'ctx': 5, 'response_handler': response_handler_a, 'goal_id': 'B', 'color': list_colors.pop()},
];
...
var contexts_b = [
    ...
    // Test Contexts!
    // has goal A (mapping b)
    {'ctx': 3, 'response_handler': response_handler_a, 'goal_id': 'A', 'color': list_colors.pop()},
    {'ctx': 4, 'response_handler': response_handler_a, 'goal_id': 'A', 'color': list_colors.pop()},
    // has goal B (popular mapping)
    {'ctx': 5, 'response_handler': response_handler_b, 'goal_id': 'B', 'color': list_colors.pop()},
];

// flip a coin to see which task the subject is going to take
var task;
var contexts;
if (Math.random() < 0.5){
  task = 'A'
...
var balance = [4, 4, 8];  // this number is doubled
var test_balance = [4, 4, 8];
...
// This is the first half of the training contexts
var context_queue = randomize_context_queue(balance.slice(), 0.20);
// This is the 2nd half of the training contexts
var block_two = randomize_context_queue(balance.slice(), 0.08);
...
function random_goal_locations() {
    ...
    // removed from these are the center 4 as well as 2 other
    // squares (3, and 32) for balance
    var third_1_goal_ids = [0, 1, 2, 4, 5, 6, 7, 8, 9, 13];
    var third_2_goal_ids = [12, 18, 19, 24, 25, 26, 27, 30, 31, 33];
    var third_3_goal_ids = [10, 11, 16, 17, 22, 23, 28, 29, 34, 35];
