...
def make_trial(context=0):
    ...
    definitions_dict = {
        ...
        1: (goal_0, action_map_1),
        2: (goal_0, action_map_1),
        3: (goal_1, action_map_0),
        4: (goal_1, action_map_1),
        5: (goal_2, action_map_0),
        6: (goal_3, action_map_1),
        # test contexts
        7:  (goal_0, action_map_0),
        8:  (goal_1, action_map_0),
        9:  (goal_2, action_map_1),
        10: (goal_3, action_map_1),
    }
...
def gen_task_param():
    ...
    contexts_b = [c + 7 for c, reps in enumerate([6, 6, 6, 6]) for _ in range(reps)]
