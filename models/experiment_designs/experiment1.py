...
def make_trial(context=0):
    ...
    definitions_dict = {
        ...
        2:  (goal_0, action_map_1),
        3:  (goal_1, action_map_0),
        4:  (goal_2, action_map_1),
        # test contexts
        5:  (goal_0, action_map_1),
        6:  (goal_1, action_map_0),
        7:  (goal_2, action_map_0),
        8:  (goal_2, action_map_1),
    }
...
def gen_task_param():
    balance = [5, 5, 10, 20, 20]
    list_start_locations = []
    list_goals = []
    list_context = []
    list_action_map = []

    contexts_a0 = randomize_context_order_with_autocorrelation(balance, repeat_probability=0.25)
    contexts_a1 = randomize_context_order_with_autocorrelation(balance, repeat_probability=0.08)
    contexts_b = [c + 5 for c, reps in enumerate([10, 10, 5, 5]) for _ in range(reps)]
